...
import com.perros.registro_perros.handler.DistritoHandler;

@Configuration
public class DistritoRouter {
    private static final String PATH_PLURAL = "/api/distritos";
    private static final String PATH_SINGULAR = "/api/distrito";

    @Bean
    RouterFunction<ServerResponse> distritosRouter(DistritoHandler handler) {
